...
export default function Contacto() {
  ...
  return (
    // 'bg-background' controla todo el fondo
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
            ...
            <motion.div variants={fadeInUp} className="space-y-4 max-w-md">
              {links.map((l) => (
                <a 
                  ...
                  // Tarjetas usan 'bg-background' y 'border-foreground/10'
          ...
          <motion.div 
            ...
            // Caja del formulario usa 'bg-background' puro
          ...
          >
            {/* Destello sutil de color en el formulario */}
            ...
            <form className="space-y-6 relative z-10">
              <div className="space-y-2">
                ...
                {/* Inputs con fondo muy suave basado en el foreground */}
                <input 
                  type="text" 
              ...
              {/* Botón Inverso: Usa bg-foreground (negro en claro, blanco en oscuro) */}
              <button className="w-full py-5 bg-foreground text-background font-black rounded-xl uppercase text-xs tracking-[0.2em] hover:scale-[0.98] transition-transform mt-4 shadow-lg">
                Enviar Mensaje
              </button>
            </form>
          </motion.div>
