...
export default function AboutSection() {
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement | HTMLAnchorElement>) => {
    ...
    const rotateX = ((y - height / 2) / height) * -6; // max 6 deg
    const rotateY = ((x - width / 2) / width) * 6; // max 6 deg
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[auto]">
        ...
        <motion.div 
          ...
          className="spotlight-card tilt-card md:col-span-2 bg-card-bg backdrop-blur-md border border-card-border rounded-[2.5rem] p-6 sm:p-8 md:p-12 shadow-sm relative overflow-hidden group hover:border-brand-violeta/30 transition-colors duration-500"
        >
          ...
          <div className="relative z-10">
            {/* Terminal Window Header styling */}
            <div className="flex items-center gap-1.5 mb-6 border-b border-foreground/10 pb-4">
              <span className="w-2.5 h-2.5 rounded-full bg-red-500/80" />
              <span className="w-2.5 h-2.5 rounded-full bg-yellow-500/80" />
              <span className="w-2.5 h-2.5 rounded-full bg-green-500/80" />
              <span className="text-[9px] text-foreground/40 font-mono font-bold ml-2">bio.json</span>
            </div>
        ...
        {/* Foto con HUD brackets */}
        <motion.div 
          variants={itemVariants}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          className="spotlight-card tilt-card md:col-span-1 min-h-[350px] md:min-h-full bg-card-bg backdrop-blur-md rounded-[2.5rem] overflow-hidden border border-card-border hover:border-brand-fucsia/30 relative group transition-colors duration-500"
        >
          <Image src="/mi-foto.jpeg" alt="Nicolas Hernandez" fill className="object-cover object-center grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 group-hover:scale-105" />
          <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent pointer-events-none" />
          
          {/* Tech HUD corner brackets */}
          <div className="absolute top-6 left-6 w-5 h-5 border-t-2 border-l-2 border-brand-fucsia/50 pointer-events-none group-hover:scale-110 group-hover:border-brand-fucsia transition-all duration-500" />
          <div className="absolute top-6 right-6 w-5 h-5 border-t-2 border-r-2 border-brand-fucsia/50 pointer-events-none group-hover:scale-110 group-hover:border-brand-fucsia transition-all duration-500" />
          <div className="absolute bottom-6 left-6 w-5 h-5 border-b-2 border-l-2 border-brand-fucsia/50 pointer-events-none group-hover:scale-110 group-hover:border-brand-fucsia transition-all duration-500" />
          <div className="absolute bottom-6 right-6 w-5 h-5 border-b-2 border-r-2 border-brand-fucsia/50 pointer-events-none group-hover:scale-110 group-hover:border-brand-fucsia transition-all duration-500" />
          ...
          <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end z-10">
            ...
            <div className="w-12 h-12 rounded-full border border-foreground/25 flex items-center justify-center backdrop-blur-sm group-hover:rotate-180 group-hover:border-brand-fucsia/50 transition-all duration-700 bg-black/10">
              <span className="text-brand-naranja text-xs shadow-[0_0_10px_var(--color-brand-naranja)]">●</span>
            </div>
          </div>
        </motion.div>

        {/* Stack con Hover Glows individuales */}
        <motion.div 
          variants={itemVariants}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          className="spotlight-card tilt-card col-span-1 bg-card-bg bg-gradient-to-br from-brand-fucsia/5 to-brand-violeta/5 backdrop-blur-md border border-card-border hover:border-brand-violeta/30 rounded-[2.5rem] p-6 sm:p-8 md:p-10 flex flex-col justify-between transition-colors duration-500"
        >
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#54C5F8]/50 hover:shadow-[0_0_20px_-2px_rgba(84,197,248,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="Flutter"
            >
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#61DAFB]/50 hover:shadow-[0_0_20px_-2px_rgba(97,218,251,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="React"
            >
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#339933]/50 hover:shadow-[0_0_20px_-2px_rgba(51,153,51,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="Node.js"
            >
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#3776AB]/50 hover:shadow-[0_0_20px_-2px_rgba(55,118,171,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="Python"
            >
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#FF2D20]/50 hover:shadow-[0_0_20px_-2px_rgba(255,45,32,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="PHP / Laravel"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#FF2D20]">
            ...
            <motion.div 
              ...
              className="w-10 h-10 rounded-xl bg-background/80 dark:bg-foreground/5 border border-foreground/10 flex items-center justify-center hover:scale-110 hover:border-[#2496ED]/50 hover:shadow-[0_0_20px_-2px_rgba(36,150,237,0.4)] transition-all duration-300 shadow-sm cursor-pointer" 
              title="Docker"
            >
        ...
        {/* Stats con Contadores Animados al Scroll */}
        <motion.div 
          variants={itemVariants}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          className="spotlight-card tilt-card col-span-1 bg-card-bg backdrop-blur-md border border-card-border rounded-[2.5rem] p-6 sm:p-8 md:p-10 flex flex-col justify-center gap-4 hover:border-brand-violeta/30 transition-colors duration-500 shadow-sm"
        >
        ...
        {/* CV (Botón Animado con Slot de Documento Mockup) */}
        <motion.div 
          variants={itemVariants}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          className="spotlight-card tilt-card col-span-1 group h-full relative"
        >
          <a href="/Nicolas_Hernandez_CV.pdf" target="_blank" rel="noopener noreferrer" className="w-full h-full bg-brand-negro border border-white/10 hover:border-transparent text-white rounded-[2.5rem] p-6 sm:p-8 md:p-10 flex flex-col items-center justify-center hover:scale-[0.97] hover:shadow-[0_0_30px_-5px_var(--color-brand-fucsia)] transition-all duration-500 relative overflow-hidden">
            ...
            {/* Futuristic Mini CV Preview Sheet */}
            <div className="absolute bottom-[-15px] right-[-15px] w-24 h-32 bg-zinc-950 border border-white/10 rounded-xl opacity-20 group-hover:opacity-40 group-hover:translate-y-[-12px] group-hover:rotate-[-8deg] transition-all duration-500 overflow-hidden hidden sm:block pointer-events-none">
              <div className="w-full h-3.5 bg-zinc-900 border-b border-white/5 p-1 flex gap-1 items-center">
              ...
              <div className="p-2 space-y-1">
                ...
                <div className="w-1/2 h-1 bg-zinc-900 rounded-sm" />
                <div className="space-y-0.5 pt-2">
                  <div className="w-full h-0.5 bg-zinc-900 rounded-sm" />
                  <div className="w-full h-0.5 bg-zinc-900 rounded-sm" />
                  <div className="w-4/5 h-0.5 bg-zinc-900 rounded-sm" />
                </div>
              </div>
            </div>

            <div className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-4 group-hover:bg-brand-fucsia/20 group-hover:border-brand-fucsia/50 transition-colors duration-500 relative z-10">
